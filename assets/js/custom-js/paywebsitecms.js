function listRegistration(data='') {
    ...
    var data = {
      ...
      category = $('#registration_datatable').DataTable({
          ...
          "dom": 'fl<"topbutton">tip',
              ...
              order: [[0, "desc"]],
              ajax: {
                  url: base_url + _admin+'PayWebsiteCms/Registration_list',
                  type: 'POST',
                  dataSrc: "data",
                  data:data
              },
      ...
      columns: [        
          ...
          { "width": "60px", title: "Name" },   
           { "width": "60px", title: "Email" },
          { "width": "100px", title: "Country Code" }, 
          // { "width": "100px", title: "Date" }, 
          { "width": "60px", title: "Mobile No" },
          // { "width": "60px", title: "Duration" },
           { "width": "60px", title: "City Name" },
