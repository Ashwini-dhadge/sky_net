...
<body>
    ...
    <!-- Centered Transparent Red Hat Background Watermark -->
    <?php if (!empty($redhat_watermark_image)) { ?>
        <div class="pos-watermark">
            <img src="<?= $redhat_watermark_image ?>" style="width: 120mm;">
        </div>
    <?php } ?>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td style="width: 34%; text-align: center; vertical-align: bottom;">
                    ...
                    <div class="meta-subtext">Verified Red Hat Credential</div>
                </td>
