...
<body>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="width: 60%; vertical-align: top;">
                    ...
                    <div class="brand-sub">Professional Linux, Cloud & Open Source Technical Education</div>
                </td>
    ...
    <!-- Award Banner -->
    <div class="pos-award">
        <div class="award-label">THIS IS PROUDLY PRESENTED TO</div>
    </div>
        ...
        <table style="width: 100%; border-collapse: collapse;" class="bottom-divider">
            <tr>
                <td style="width: 70%; vertical-align: middle;">
                    © <?= date('Y') ?> Skynet Linux Solutions & Training Centre. All Rights Reserved.
                </td>
