            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 d-flex justify-content-between ">
                        <h4 class="my-3 px-3">User Result Report</h4>
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent">
                                <li class="breadcrumb-item"><a href="<?= base_url('admin/UserResultReport') ?>">User Result Report</a></li>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group mx-2">
                                        <div>
                                            <button class="btn btn-danger" onclick="applyResult()">
                                                Apply
                                            </button>
                                        </div>
                                    ...
                                    <div class="form-group  ">
                                        <div>
                                            <button class="btn btn-danger" onclick="applyReset()">
                                                Reset
                                            </button>
                                        </div>
                                    </div>
