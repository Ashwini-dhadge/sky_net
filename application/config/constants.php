...
define('SESSION_EXPIRED', 'Session expired. Please try again');
...
define('INVALID_INPUT', 'Invalid inputs');
define('USER_NOT_FOUND', 'User Not Found');

/*********** Application Constants***************/
define('APP_NAME', 'SKYNET');
...
define('DASHBOARD', 'dashboard' . DS);
define('COURSE', 'course' . DS);
define('QUESTION', 'question' . DS);
define('AUTH', 'auth/');
define('USER', 'user' . DS);
...
define('COURSE_CERTIFICATES', 'uploads/user_certificates/');
